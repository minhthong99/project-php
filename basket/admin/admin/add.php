    ...
    <div id="layoutSidenav_content">
        ...
        if (isset($_POST['submit'])) {
            ...
            if (empty($error)) {
                ...
                $query = "INSERT INTO admin(name,email,password,level) VALUES ('{$name}','{$email}','{$md5Password}','{$level}') ";
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-header-text">Thêm Admin</h5>
                    <div class="f-right">
                ...
                <?php if ( !empty($_SESSION['success'])) { ?>
                    ...
                    <div class="card-block">
                        <form role="form" method="POST">
                            ...
                            <div class="form-group ">
                                <label for="example-tel-input" class="col-xs-2 col-form-label form-control-label">Level</label>
                                <div class="col-sm-10">
